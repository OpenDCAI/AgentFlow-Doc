...
```
Need warmup or Session?
    │
    ├── No -> Lightweight API Tool
    │        └── @register_api_tool
    │
    └── Yes -> Heavyweight Backend
             │
             │ Need globally shared resources?
             │
             ├── Yes -> Implement warmup() / shutdown()
             │
             └── Need worker-independent resources?
                  │
                  └── Yes -> Implement initialize() / cleanup()
```

## Related Documentation

- [Backend Development Overview](./backend/backend_overview.md)
- [API Tool Development](./backend/api_tool_development.md)
- [Resource Backend Development](./backend/resource_backend_development.md)
- [Registration Guide](./backend/registration_guide.md)
